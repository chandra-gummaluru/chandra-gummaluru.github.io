...
> **Def. Derivative**:
> The rate of change of a function, $f: \mathbb{R}^n \rightarrow \mathbb{R}$, at some point $\mathbf{z} \in \text{dom}(f)$ in the direction, $\mathbf{v} \in \mathbb{R}^n$ is defined as
