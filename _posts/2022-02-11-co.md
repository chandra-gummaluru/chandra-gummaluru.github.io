...
<details>
 <summary><strong>See proof</strong>.</summary>
<p>
Suppose $x$ is locally optimal, but there exists a feasible point, $y$, such that $f_0(y) < f_0(x)$. Since $x$ is locally optimal, for any feasible point $z$, we have
\[\|x-z\|_2 \leq R \Rightarrow f_0(z) \geq f_0(x)\]
where $R > 0$.
                                                                                                    <br><br>
Since $g$ is a scalar function of $t$, it is convex if and only if
\[g''(t) \geq 0.\]
