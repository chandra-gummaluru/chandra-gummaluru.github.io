...
### Duality in Convex Optimization
   ...
   \\[\begin{bmatrix} \lambda^{\top} & \mu^{\top} & w \end{bmatrix}\begin{bmatrix} v \\\\\\ u \\\\\\ t  \end{bmatrix} \geq \begin{bmatrix} \lambda^{\top} & \mu^{\top} & w \end{bmatrix}\begin{bmatrix} 0 \\\\\\ 0 \\\\\\ f^\* \end{bmatrix}\\]
   If $w \neq 0$, we may write
