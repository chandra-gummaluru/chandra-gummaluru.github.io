...
> **Def. Generalized Inequality**: consider a proper cone, $K$, and two points, $x, y \in K$. We say that $x \leq\_K y$ iff $(y-x) \in K$, and $x <\_K y$ iff $(y-x) \in \text{int}(K)$. Note that $x \leq_K y, y \leq_K x \not\Rightarrow x = y$. 
