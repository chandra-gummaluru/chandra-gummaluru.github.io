...
> **Def. Derivative**:
> The rate of change of a function, $f: \mathbb{R}^n \rightarrow \mathbb{R}$, at some point $x_0 \in \text{dom}(f)$ in the direction, $v \in \mathbb{R}^n, \|v\|\_2 = 1$ is defined as
> \\[D_vf(x_0) := \lim_{t \rightarrow 0}\frac{f(x_0 + tv) - f(x_0)}{t}.\\]
> We call $D_vf(x_0)$ the **directional derivative** of $f$ at $x_0$ in the direction, $v$. If $v = \bm{e}\_1$, then we call $D_{v}f(x_0)$ the **partial derivative** of $f$ at $x_0$ w.r.t. $x_i$, and denote it as $\left.\partial f / \partial x_i\right\vert_{x=x_0}$.
