...
<br><br>
 If we take $z = \theta x + (1-\theta)y$ where $\theta = R/\left(2\|x-y\|_2\right)$. Since $\|y-x\|_2 > R$, it follows that $0 \leq \theta \leq 1/2$. In other words, $z$ is a convex combination of two feasible points, and is hence, also feasible. Moreover, $\|x-z\|_2 = R/2$.
<br><br>
