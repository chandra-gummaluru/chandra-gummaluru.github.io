...
> We call $D_vf(x_0)$ the **derivative** of $f$ at $x_0$ in the direction, $v$. If $v = e_i$, then we call $D_{v}f$ the **partial derivative** of $f$ at $x_0$ w.r.t. $x_i$, and denote it as $\left.\partial f / \partial x_i\right\vert_{x=x_0}$.
 
Computing a partial derivative is relatively straight-forward. However, computing a derivative for any $v$ from the aformentioned definition is often difficult. However, there are several theorems that can help.
...
> **Thm. Relating the Gradient and Directional Derivatives**:
