...
We will consider a function, $f: \mathbb{R}^n \rightarrow \mathbb{R}$, where $\text{dom}(f) \subseteq \mathbb{R}^n$.

> **Def. Continuous Function**<br>
> A function, $f: \mathbb{R}^n \rightarrow \mathbb{R}$ is **continuous** at a point, $x_0 \in \text{dom}(f)$ iff
> \\[\lim_{x\rightarrow x_0}f(x) = f(x_0).\\]
> We say $f$ is continuous if it is continuous at every $x_0 \in \text{dom}(f)$.
...
A function, $f$, is convex if and only if it is convex when restricted to a line.
