...
> We call $D_vf(x_0)$ the (directional) **derivative** of $f$ at $x_0$ in the direction, $v$. If $v = e_i$, then we call $D_{v}f$ the **partial derivative** of $f$ at $x_0$ w.r.t. $x_i$, and denote it as $\left.\partial f / \partial x_i\right\vert_{x=x_0}$.
...
It turns out that we can compute the derivative of $f$ is any direction, $v$, using just its partial derivatives.
