...
<br><br>
he conditions derived thus far are fairly weak. However, we can derive stronger conditions in some cases. To do this, we first the so-called Lagrangian of $f$ as
...
Thus, the following conditions must hold on $(x^\*, \lambda^\*, \mu^\*)$:
