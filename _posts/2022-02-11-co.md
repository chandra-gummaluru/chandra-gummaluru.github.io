...
We saw that $f(x^\*) - \zeta(\lambda^\*, \mu^\*)$ as the duality-gap, which is always non-negative as per the previous argument. We want to find conditions under which the duality gap is zero. 
