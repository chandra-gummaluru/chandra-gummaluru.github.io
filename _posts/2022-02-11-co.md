...
A vector function, $f: \mathbb{R}^n \rightarrow \mathbb{R}^m$ can be interpreted as $m$ scalar functions, $f_1, \dots, f_m: \mathbb{R}^n \rightarrow \mathbb{R}$. Thus, we define its derivative accordingly, i.e.,
\\[D_vf = \begin{bmatrix} D_vf_1 \\\\ \vdots \\\\ D_vf_m \end{bmatrix},\\]
and
