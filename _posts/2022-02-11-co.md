...
We interpret $u^{\top}\nabla^2 f(x_0)v$ as the $u$-directional derivative of the $v$-directional derivative of $f$ at $x_0$. Indeed, we have
...
&= \sum_{i=1}^{n}u_i\frac{\partial}{\partial x_i}\sum_{j=1}^{n}v_j\frac{\partial f}{\partial x_j} \\\\
&= \sum_{i=1}^{n}u_i\frac{\partial}{\partial x_i}\nabla f^{\top}v \\\\
