...
Everything we've discussed this far can be generalized by generalizing inequalities in multiple dimensions. To do this, we consider a proper cone, $K$, and two points, $x, y \in K$. We say that $x \leq\_K y$ iff $(y-x) \in K$, and $x <\_K y$ iff $(y-x) \in \text{int}(K)$.
