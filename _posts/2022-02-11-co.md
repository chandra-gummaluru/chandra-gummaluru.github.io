...
### Operations that Preserve Convexity
   ...
   \\[\begin{equation}\begin{aligned}\text{minimize } &t \\\\ \text{subject to } &f(x) \leq t \\\\ &g_i(x) \leq 0, i = 1,\dots, m \\\\ &Ax+b =0\end{aligned}\end{equation}\\]
