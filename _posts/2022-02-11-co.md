...
> We call $D_{v}f(x)$ the **directional derivative** of $f$ at $x$ in the direction, $v$. If $\mathbf{v} = \mathbf{e}\_1$, then we call $D_{v}f(x)$ the **partial derivative** of $f$ at $x$ w.r.t. $x_i$, and denote it as $\partial f / \partial x_i(x)$.
