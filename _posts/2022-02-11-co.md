...
where $\lambda_i \geq 0, i = 1, \dots, m$. These definitions may seem arbitrary, but the idea is that for any feasible $x$, $L_f(x,\lambda,\mu) \leq f(x)$, and so $\zeta(\lambda,\nu) \leq f(x^\*)$.
