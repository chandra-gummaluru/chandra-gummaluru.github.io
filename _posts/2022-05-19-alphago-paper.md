...
<img src="https://github.com/chandra-gummaluru/chandra-gummaluru.github.io/raw/master/media/go/min_max_search_end.svg" width="630px"/>*The utility of each node relative to the turn-taker after completing the (NM) algorithm on a simple game tree.*
...
<img src="https://github.com/chandra-gummaluru/chandra-gummaluru.github.io/raw/master/media/go/minmax_ee.svg" width="630px"/>
...
\\[\hat{a}(s,i) = \text{arg max}\_{a \in \mathcal{A}(s)}\left\lbrace \hat{u}\left(a(s),i\right) + \sqrt{\frac{2c\log{i}}{N\left(a(s),i\right)}}\right\rbrace\tag{UCT}\\]
