...
Finding a good $h$ is very difficult. Even if we had a good $h$, it is not obvious which parts of the tree should be explored further if we have time to run another iteration.
