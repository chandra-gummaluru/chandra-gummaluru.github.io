...
> **Independent and Complement Subspaces**: Let $\mathcal{U}$ and $\mathcal{V}$ be subspaces of $\mathcal{X}$. We say that $\mathcal{U}$ and $\mathcal{V}$ are \textbf{independent} if $\mathcal{U} \cap \mathcal{V} = \left\lbrace \bm{0} \right\rbrace$ and \textbf{complements} if $\mathcal{U} + \mathcal{V} = \mathcal{X}$.
> <br><br>
